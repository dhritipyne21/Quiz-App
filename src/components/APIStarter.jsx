...
const APIStarter = () => {
  ...
  //       description: null,
  //       answers: {
  //         answer_a: "Request.Form;",
  //         answer_b: "Request.QueryString;",
  //         answer_c: "$_GET[];",
  //         answer_d: "$_GET.QueryString",
  //         answer_e: null,
  //         answer_f: null,
  //       },
  ...
  //     {
  //       id: 724,
  //       question: "How to list all Kubernetes services in the current namespace?",
  //       description: null,
  //       answers: {
  //         answer_a: "kubectl get-all services",
  //         answer_b: "kubectl print services",
  //         answer_c: "kubectl dump services",
  //         answer_d: "kubectl get services",
  //         answer_e: null,
  //         answer_f: null,
  //       },
  //       multiple_correct_answers: "false",
  ...
  //       id: 1007,
  //       question:
  //         "On which of the following systems can minikube be installed on? Select one.",
  //       description: null,
  //       answers: {
  //         answer_a: "Linux",
  //         answer_b: "Windows",
  ...
  //     {
  //       id: 643,
  //       question: "What do the initials of PHP stand for?",
  //       description: null,
  //       answers: {
  //         answer_a: "Hypertext Parser.",
  //         answer_b: "Hyperloop Preprocessor.",
  //         answer_c: "Hypertext Preprocessor.",
  //         answer_d: null,
  //         answer_e: null,
  //         answer_f: null,
  //       },
  ...
  //     {
  //       id: 924,
  //       question: "Which of the following is not a services in Kubernetes?",
  //       description: null,
  //       answers: {
  //         answer_a: "Cluster IP",
  //         answer_b: "Node port",
  //         answer_c: "Load Balancer",
  //         answer_d: "External name",
  //         answer_e: "Container Proxy",
  //         answer_f: null,
  //       },
  //       multiple_correct_answers: "false",
  //       correct_answers: {
  ...
  //     {
  //       id: 676,
  //       question: "What is the login name of the administrator in Linux?",
  //       description: null,
  //       answers: {
  //         answer_a: "root",
  //         answer_b: "administrator",
  //         answer_c: "admin",
  //         answer_d: "All of the mentioned",
  //         answer_e: "None of the mentioned",
  //         answer_f: null,
  //       },
  //       multiple_correct_answers: "false",
  //       correct_answers: {
